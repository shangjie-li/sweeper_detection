...
from ..box_utils_coco import decode, jaccard, index2d
from utils_coco import timer

from data_coco import cfg_coco, mask_type_coco

import numpy as np


class Detect_coco(object):
    ...
    def __call__(self, predictions, net):
        ...
        Args:
            ...
            prior_data: (tensor) Prior boxes and variances from priorbox layers
                Shape: [num_priors, 4]
            proto_data: (tensor) If using mask_type_coco.lincomb, the prototype masks
    ...
    def fast_nms(self, boxes, masks, scores, iou_threshold:float=0.5, top_k:int=200, second_threshold:bool=False):
        ...
        # Only keep the top cfg_coco.max_num_detections highest scores across all classes
        scores, idx = scores.sort(0, descending=True)
        idx = idx[:cfg_coco.max_num_detections]
        scores = scores[:cfg_coco.max_num_detections]
    ...
    def traditional_nms(self, boxes, masks, scores, iou_threshold=0.5, conf_thresh=0.05):
        ...
        idx2 = idx2[:cfg_coco.max_num_detections]
        scores = scores[:cfg_coco.max_num_detections]
        ...
        return boxes[idx] / cfg_coco.max_size, masks[idx], classes, scores
